...
import { PROGRAM_FRAME_WEEK } from '../../../constants/routeConstants';
...
const getLastSunday = () => {
    ...
    lastSunday.setDate(today.getDate() - today.getDay()); // Go back to last Sunday
    return lastSunday;
  };

const ProgramFrameWeekDetail = (props) => {
    const nullForm = {
        title: '',
        status: 'IN_PROGRESS',
        sector: 'TV',
        airdate: getLastSunday(),
...
const mapDispatchToProps = (dispatch) => ({
    ...
    create: (data) => dispatch(planActions.create(PROGRAM_FRAME_WEEK_API, data)),
    update: (id, data) => dispatch(planActions.update(PROGRAM_FRAME_WEEK_API, id, data)),
});

export default connect(mapStateToProps, mapDispatchToProps)(ProgramFrameWeekDetail);
